...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 items-center justify-between hidden w-full h-16 px-3 border-b border-gray-800 bg-main bg-opacity-70 md:flex backdrop-blur backdrop-filter firefox:bg-opacity-90">
      <Link href="/">
        <Image
          src={logo}
          alt="logo"
